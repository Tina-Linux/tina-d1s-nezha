############################################################################################
# 			d1s-nezha busybox-init-base-files for tina(OpenWrt) Linux
#
#	d1s-nezha busybox-init-base-files will generate shell script according to some 
...
all:
	@echo ==================================================
	@echo target/allwinner/d1s-nezha/tina_busybox-init-basefiles.mk is called to generate shell scripts
	@echo ==================================================
...
clean:
	@echo ==================================================
	@echo target/allwinner/d1s-nezha/tina_busybox-init-basefiles.mk is called to clean shell scripts
	@echo ==================================================
